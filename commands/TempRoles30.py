...
class TempRoles30(commands.Cog):
    ...
    async def time(self, ctx):
        ...
        with open('.\\databases\\time.json', 'r') as file:
            ...
            if user_id in calender_data:
                ...
                await ctx.send("Du hast noch 30 Minuten verfügbar.")            
